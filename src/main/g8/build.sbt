...
import quasar.$connectorType$.project._
...
lazy val lwc = project
  .settings(name := "quasar-$connectorType$")
  .settings(commonSettings)
...
lazy val repl = project
  ...
  .settings(
    ...
    |import quasar.physical.$connectorType$._
...
/** $connectorType$-specific integration tests
  */
lazy val it = project
  .settings(name := "quasar-$connectorType$-it")
